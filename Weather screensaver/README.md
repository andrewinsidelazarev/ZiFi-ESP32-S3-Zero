...
<p align="center">
  <img src="screenshot.png" alt="Экран заставки: место, часы, дата, текущая погода, прогноз на 5 дней и лента недели" width="720">
</p>
<p align="center"><sub>Кадр из видеопамяти, нарисованный кодом плагина в машинном тесте (увеличен вдвое)</sub></p>

[`build/WEATHER.WMF`](build/WEATHER.WMF) — экранная заставка для Wild Commander на ZX Evolution
...
4. Нужна прошивка ZiFi `s3-native-0.6.92` или новее (обновляется плагином
   [`ZIFIUPD.WMF`](../Online%20Update/build/ZIFIUPD.WMF)): в ней есть команда
   `WEATHER_GET`, см. [`docs/PROTOCOL.md`](../docs/PROTOCOL.md).

Часы и дата берутся из часов Mr.Gluk. Чтобы они шли точно, держите в
`[PLUGINS]` плагин [`NTPTIME.WMF`](../NTP%20Time%20Sync/build/NTPTIME.WMF) — он
...
Разбор ответов сервисов в прошивке проверяет
[`tests/test_weather_parse.py`](../tests/test_weather_parse.py) в
