...
; Page1 принимает распакованные 512-байтные блоки и публикуется по 16 КиБ.
...
; Таблицы табличного CRC16. Выравнивание на 256 обязательно: индекс кладётся
; прямо в L, а старший байт адреса берётся константой, поэтому таблица обязана
; начинаться на границе страницы. Заполняет их Vfs_Crc16Init при старте.
        ALIGN 256
VfsCrcHi:       ds 256
VfsCrcLo:       ds 256
...
mainEnd:
        ...
        ENT
endCode:
        SAVEBIN "../build/ZIFIFTP.WMF",startCode,endCode-startCode
