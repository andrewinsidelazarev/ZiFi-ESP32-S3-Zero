        ...
        if (rep->output_buffer_length > 0 && rep->output_buffer) {
                ...
                case SMB2_0_INFO_FILE:
                        ...
                        case SMB2_FILE_EA_INFORMATION:
                                created_output_buffer_length =
                                        smb2_encode_file_ea_info(smb2,
                                                (struct smb2_file_ea_info *)rep->output_buffer, iov);
                                break;
                        ...
                        case SMB2_FILE_INTERNAL_INFORMATION:
                                created_output_buffer_length =
                                        smb2_encode_file_internal_info(smb2,
                                                (struct smb2_file_internal_info *)rep->output_buffer, iov);
                                break;
                                 ...
                                 struct smb2_pdu *pdu)
{
        ...
        case SMB2_0_INFO_FILE:
                ...
                case SMB2_FILE_EA_INFORMATION:
                        ...
                        if (smb2_decode_file_ea_info(smb2, ptr, ptr, &vec)) {
                                smb2_set_error(smb2, "could not decode file "
                                               "EA info. %s",
                                               smb2_get_error(smb2));
                                return -1;
