...
int smb2_decode_file_ea_info(struct smb2_context *smb2,
                             void *memctx,
                             struct smb2_file_ea_info *fs,
                             struct smb2_iovec *vec);

int smb2_encode_file_ea_info(struct smb2_context *smb2,
                             struct smb2_file_ea_info *fs,
                             struct smb2_iovec *vec);
...
int smb2_encode_file_internal_info(struct smb2_context *smb2,
