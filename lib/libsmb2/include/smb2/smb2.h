...
struct smb2_tree_connect_reply {
        ...
        /* Только для серверной стороны: 0 оставляет старую авто-нумерацию. */
        uint32_t tree_id;
};
...
/* Размер неподвижной части FILE_FULL_DIR_INFORMATION до имени файла. */
#define SMB2_FILE_FULL_DIRECTORY_INFORMATION_SIZE    68
#define SMB2_FILE_BOTH_DIRECTORY_INFORMATION_SIZE    94
