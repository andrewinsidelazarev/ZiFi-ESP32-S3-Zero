...
"%SJASM%" --inc="%SHARED_Z80%" --sym=..\build\update.sym --lst=..\build\update.lst update.asm
if errorlevel 1 exit /b 1

copy /y "..\build\update.sna" "..\..\firmware\update.sna" >nul
if errorlevel 1 exit /b 1
echo Built: %~dp0..\firmware\update.sna
