...
NET_PORT            equ 80          ; как в оригинале: только http, без tls
...
NET_WAIT_OPEN       equ 600             ; около пятнадцати секунд
...
; Запросить файл по HTTP. Адрес сервера лежит в cmd_conn2site_adr, путь — в
; request_path, оба строкой с нулём; и то и другое положил parse_url.
